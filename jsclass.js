(function(global){
		...
		var Class2 = function(){
			...
			var createClass = function(){
				...
				if(args.extendInfo){
					...
					if(!("super" in proto)) Object.defineProperty(proto, "super", {
						configurable:	false,
						enumerable:		false,
				...
				// We reference the passed constructor in the prototype so that getSuper will be able to see it.
				Object.defineProperty(proto, "__constructor", {
					configurable:	false,
					enumerable:		false,
	...
	// Defining outside of strict mode in order to use the caller property
	function getSuper(){
